%-----------------------------------------------------------------------
% Job saved on 27-Aug-2018 14:13:24 by cfg_util (rev $Rev: 6942 $)
% spm SPM - SPM12 (7219)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
clear matlabbatch
matlabbatch{1}.spm.dcm.bms.inference.dir = {[dat_fol '/connection_family_comparison']};
matlabbatch{1}.spm.dcm.bms.inference.sess_dcm = {};
matlabbatch{1}.spm.dcm.bms.inference.model_sp = {[dat_fol '/connection_family_comparison/all_subs_allmodels_cortconn_test.mat']};
