...
%-----------------------------------------------------------------------
clear matlabbatch
matlabbatch{1}.spm.dcm.bms.inference.dir = {[dat_fol '/connection_family_comparison/control_analyses/trn_BMS']};
matlabbatch{1}.spm.dcm.bms.inference.sess_dcm = {};
matlabbatch{1}.spm.dcm.bms.inference.model_sp = {[dat_fol '/connection_family_comparison/control_analyses/train_grp_allmodels_cortconn_test.mat']};
