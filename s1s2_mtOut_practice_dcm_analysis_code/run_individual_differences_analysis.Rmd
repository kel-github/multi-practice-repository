...
fname = "~/Dropbox/QBI/mult-conn/multi-practice-repository/s1s2_mtOut_practice_dcm_analysis_outdata/behav_correlations/sub_b_params.csv"
params = get.b.data(fname)
cons.of.int = c("lput_to_lipl", "lput_to_smfc", "lipl_to_lput")
...
data = data %>% mutate( pre_sing_total = Pre_VS + Pre_AS,
                        ...
                        prct_down = 100 - ((post_sing_total/pre_sing_total)*100) )
