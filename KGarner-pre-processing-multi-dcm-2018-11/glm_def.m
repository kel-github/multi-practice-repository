%-----------------------------------------------------------------------
% Job saved on 01-Jul-2015 16:20:45 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6470)
...
matlabbatch{1}.spm.stats.fmri_spec.fact.name = 'trialType';
matlabbatch{1}.spm.stats.fmri_spec.fact.levels = 3;
