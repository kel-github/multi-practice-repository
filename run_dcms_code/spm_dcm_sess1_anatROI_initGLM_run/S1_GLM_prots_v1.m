function S1_GLM_prots_v1(sub,n_s1_runs, s1_runs, fpath)
...
save(sprintf([fpath '/sub_%d_out_anatROI_initGLM/FSTL_GLM/%d_DCMSPMSESS_onsets.mat'],sub,sub),'names','durations','onsets');
