...
matlabbatch{1}.spm.util.voi.roi{1}.spm.thresh = .01;
matlabbatch{1}.spm.util.voi.roi{1}.spm.extent = 4; % in voxels
...
matlabbatch{2}.spm.util.voi.roi{1}.spm.thresh = .01;
matlabbatch{2}.spm.util.voi.roi{1}.spm.extent = 4;
% The mask bounding the ROI's mask.
...
matlabbatch{3}.spm.util.voi.roi{1}.spm.thresh = .01;
matlabbatch{3}.spm.util.voi.roi{1}.spm.extent = 4;
% The mask bounding the ROI's mask.
