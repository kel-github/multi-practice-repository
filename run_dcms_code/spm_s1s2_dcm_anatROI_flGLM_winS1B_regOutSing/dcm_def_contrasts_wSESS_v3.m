...
% v3 adjusts for effects of interest that inc multi, practice
...
matlabbatch{1}.spm.stats.con.consess{2}.fcon.weights(1,:) = 0;
matlabbatch{1}.spm.stats.con.consess{2}.fcon.weights(2,:) = 0;
