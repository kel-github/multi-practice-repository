...
%%%%%%%%%%%% this version '_regOutMult' regresses out multitask trials, to
%%%%%%%%%%%% look at the effect of training on single-trials

clear all
%start = tic
tmpdir = getenv('TMPDIR');
%tmpdir = pwd;
sfol = 'sub_%d_out_s1s2_anatROI_initGLM_regOutMult';
